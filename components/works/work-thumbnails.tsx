...
export function WorkThumbnails({ images, className }: WorkThumbnailsProps) {
      ...
      <div className={cn("flex flex-wrap gap-2", className)}>
        {images.map((image, index) => (
          <button
            ...
            className="relative size-24 shrink-0 overflow-hidden rounded-lg border border-[#e4e6f7]"
